...
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaGitAlt, FaGithub, FaNpm, FaBootstrap,  } from "react-icons/fa"
import {
  SiNextdotjs,
  SiTailwindcss,
...
export default function Skills() {
  ...
  const skills = [
    ...
    { name: "Bootstrap", icon: <FaBootstrap className="text-[#E34F26]" size={24} /> },
